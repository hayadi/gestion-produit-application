...
class ClientGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Client entity")
        ...
        .repeat(2) {
            ...
            .get("/gestionproduitapplication/api/clients")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new client")
            .post("/gestionproduitapplication/api/clients")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "nom":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/gestionproduitapplication${new_client_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created client")
            .delete("/gestionproduitapplication${new_client_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
